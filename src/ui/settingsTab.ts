...
import type ProgressClockPlugin from '../main';

export class ProgressClockSettingTab extends PluginSettingTab {
	plugin: ProgressClockPlugin;
	...
	display(): void {
		...
		containerEl.createEl('h2', { text: 'Settings - Obsidian Progress Clock' });

		containerEl.createEl('h3', { text: "General" });

		new Setting(containerEl)
			.setName("Show Button in Context Menu")
			.setDesc("If enabled, you will see a Button in your Editor Context Menu to open the Progress Clock Creator.")
			.addToggle(cb => {
				cb
		...
		new Setting(containerEl)
			...
			.addButton((bt) => {
				bt.buttonEl.outerHTML = `<a href="https://ko-fi.com/djretief"><img src="https://uploads-ssl.webflow.com/5c14e387dab576fe667689cf/61e11e22d8ff4a5b4a1b3346_Supportbutton-1.png"></a>`;
			});
		...
		desc.append(
			"Set the default Colors for your Progress Clocks. This will set the border Color and the inner Color will be the same, but with less opacity. This ensures better compatibility with Dark and Light Mode. ",
			"You can use any ",
			desc.createEl("a", {
		...
		// 		new Setting(containerEl)
		// 			.setName(nameEl)
		// 			.setDesc('This will be the border Color used in the Progress Clocks you create.')
		// 			.addButton(btn => {
